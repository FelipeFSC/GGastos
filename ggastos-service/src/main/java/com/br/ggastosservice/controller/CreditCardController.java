...
public class CreditCardController {
    ...
    public List<CreditCard> findByEnabled(@PathVariable boolean enabled) throws Exception {
        return creditCardService.findByEnabled(enabled);
    }

    @ResponseBody
    @ResponseStatus(HttpStatus.CREATED)
    @RequestMapping(method = RequestMethod.POST, consumes = {"application/json"}, produces = {"application/json"})
    public CreditCard create(@RequestBody CreditCard creditCard) throws Exception {
